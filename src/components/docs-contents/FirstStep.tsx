    ...
    <div>
      ...
      <div className='ml-1 sm:ml-1 md:ml-2 lg:ml-4 xl:ml-8 2xl:ml-16 mr-1 sm:mr-1 md:mr-2 lg:mr-4 xl:mr-8 2xl:mr-16'>
        ...
        <div>
          ...
          <blockquote>
            <p>
              Requests เป็น library ของภาษา Python ที่ใช้ในการทำ HTTP requests ต่างๆ ได้ง่ายและสะดวก
              มีฟังก์ชั่นที่ช่วยให้เราสร้าง request, ส่ง request ไปยัง server, รับ response จาก server, และจัดการกับ
              response ได้ง่ายๆ เช่น GET, POST, PUT, DELETE
            </p>
          </blockquote>
        </div>
        <p>
        ...
        <p className='ml-8'>response =requests.get(url) 👈 เราจะได้ ข้อมูล HTML ทั้งหน้าของ จ.ลำพูน</p>
        <p className='ml-8'>

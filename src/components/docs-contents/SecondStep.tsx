  ...
  return (
    <div>
      ...
      <p className='indent-10'>
        ...
        ในการดึงข้อมูลที่อยู่ใน tag {'<li>'} ออกมา และดึงข้อมูลที่เป็น content ภายใน tag นั้นออกมาอีกที โดยมีโค้ดดังนี้
      </p>
      ...
      <section className='flex flex-col gap-2 leading-relaxed'>
        ...
        <div className=' border-blue-500 bg-stone-50 shadow border-l-4 border-0 px-4 py-4 rounded-md'>
          <ul className='space-y-3'>
            ...
            <li>
              <span className='bg-stone-200 px-2 py-0.5 rounded-lg'>{'[^<>]+'}</span> คือการ match ตัวอักษรที่ไม่ใช่{' '}

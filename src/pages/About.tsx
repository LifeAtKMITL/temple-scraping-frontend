...
const members: MemberData[] = [
  {
    ...
    imgStyles: 'absolute -bottom-4 -right-[100px] xl:-right-[140px]',
    imgSize: 'w-[230px] xl:w-[260px]',
  },
  {
    _id: '2',
    ...
    imgStyles: 'absolute -bottom-5 -right-[80px]',
    imgSize: 'w-[160px]',
  },
  {
    _id: '3',
    ...
    imgStyles: 'absolute -bottom-7 -right-[110px] ',
    imgSize: 'w-[180px]',
  },
  {
    _id: '4',
    ...
    imgStyles: 'absolute -bottom-5 -right-[70px]',
    imgSize: 'w-[180px]',
  },
  {
    _id: '5',
    ...
    imgStyles: 'absolute -bottom-4 -right-[80px]',
    imgSize: 'w-[200px]',
  },
  {
    _id: '6',
    ...
    imgStyles: 'absolute -bottom-3 -right-[110px] xl:-right-[120px]',
    imgSize: 'w-[250px] xl:w-[260px]',
  },
  {
    _id: '7',
    ...
    imgStyles: 'absolute -bottom-6 -right-[70px]',
    imgSize: 'w-[150px]',
  },
  {
    _id: '8',
    ...
    imgStyles: 'absolute -bottom-6 -right-[80px]',
    imgSize: 'w-[160px]',
  },
  {
    _id: '9',
  ...
  },
  {
    ...
    imgStyles: 'absolute -bottom-2 -right-[95px]',
    imgSize: 'w-[190px] xl:w-[210px]',
  },
];
...
export default function About() {
  return (
    <div className='bg-bg h-screen overflow-auto'>
      ...
      <div className='grid md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 container mx-auto justify-items-center pt-[20px] pb-[90px] gap-36 pr-[80px]'>
        {members
